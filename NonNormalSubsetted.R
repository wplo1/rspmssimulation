...
resdf <- foreach(i=1:nsim, .combine = 'rbind') %dopar% {
  ...
  resul <- list()
  resul$seed<-i
  muST<-0.8; sigmaST<-0.3; muSC<-0.5; sigmaSC<-0.1;
  aYT<-10;bYT<-0.05;aYC<-4; bYC<-0.9;
...
muST<-0.8; sigmaST<-0.3; muSC<-0.5; sigmaSC<-0.1;aYT<-10;bYT<-0.05;aYC<-4; bYC<-0.9;
...
XNormalSubset200LL1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
XNormalSubset200LL3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
muST<-0.8; sigmaST<-0.3; muSC<-0.5; sigmaSC<-0.1;aYT<-0.5;bYT<-0.6;aYC<-2; bYC<-1;
YTYT<-function(x){1/(1+exp(-aYT*(x-exp(bYT))^3-log(x)))};YCYC<-function(x){1/(1+exp(-aYC*(x-exp(bYC))^3-log(x)))}
STST<-function(x){dlnorm(x,mean=muST,sd=sigmaST)};SCSC<-function(x){dlnorm(x,mean=muSC,sd=sigmaSC)}
TCTC<-integrate(function(x){YTYT(x)*SCSC(x)},0,Inf)
TTTT<-integrate(function(x){YTYT(x)*STST(x)},0,Inf)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset200ML1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset200ML3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
muST<-0.8; sigmaST<-0.3; muSC<-0.5; sigmaSC<-0.1;aYT<-5;bYT<-0.2;aYC<-1; bYC<-0.6;
YTYT<-function(x){1/(1+exp(-aYT*(x-exp(bYT))^3-log(x)))};YCYC<-function(x){1/(1+exp(-aYC*(x-exp(bYC))^3-log(x)))}
STST<-function(x){dlnorm(x,mean=muST,sd=sigmaST)};SCSC<-function(x){dlnorm(x,mean=muSC,sd=sigmaSC)}
TCTC<-integrate(function(x){YTYT(x)*SCSC(x)},0,Inf)
TTTT<-integrate(function(x){YTYT(x)*STST(x)},0,Inf)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset200MM1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset200MM3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
muST<-0.8; sigmaST<-0.3; muSC<-0.5; sigmaSC<-0.1;aYT<-2;bYT<-0.3;aYC<-0.2; bYC<-0.6;
YTYT<-function(x){1/(1+exp(-aYT*(x-exp(bYT))^3-log(x)))};YCYC<-function(x){1/(1+exp(-aYC*(x-exp(bYC))^3-log(x)))}
STST<-function(x){dlnorm(x,mean=muST,sd=sigmaST)};SCSC<-function(x){dlnorm(x,mean=muSC,sd=sigmaSC)}
TCTC<-integrate(function(x){YTYT(x)*SCSC(x)},0,Inf)
TTTT<-integrate(function(x){YTYT(x)*STST(x)},0,Inf)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset200MH1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset200MH3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
muST<-0.8; sigmaST<-0.3; muSC<-0.5; sigmaSC<-0.1;aYT<-1;bYT<-0.5;aYC<-10; bYC<-0.6;
YTYT<-function(x){1/(1+exp(-aYT*(x-exp(bYT))^3-log(x)))};YCYC<-function(x){1/(1+exp(-aYC*(x-exp(bYC))^3-log(x)))}
STST<-function(x){dlnorm(x,mean=muST,sd=sigmaST)};SCSC<-function(x){dlnorm(x,mean=muSC,sd=sigmaSC)}
TCTC<-integrate(function(x){YTYT(x)*SCSC(x)},0,Inf)
TTTT<-integrate(function(x){YTYT(x)*STST(x)},0,Inf)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset200HM1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
RSRS
#### XNormalSubset200HM3 ####
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset200HM3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
muST<-0.8; sigmaST<-0.3; muSC<-0.5; sigmaSC<-0.1;aYT<-1;bYT<-0.7;aYC<-10; bYC<-0.6;
YTYT<-function(x){1/(1+exp(-aYT*(x-exp(bYT))^3-log(x)))};YCYC<-function(x){1/(1+exp(-aYC*(x-exp(bYC))^3-log(x)))}
STST<-function(x){dlnorm(x,mean=muST,sd=sigmaST)};SCSC<-function(x){dlnorm(x,mean=muSC,sd=sigmaSC)}
TCTC<-integrate(function(x){YTYT(x)*SCSC(x)},0,Inf)
TTTT<-integrate(function(x){YTYT(x)*STST(x)},0,Inf)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset200HH1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset200HH3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time



#### XNormalSubset1000LL1 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset1000LL1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time

#### XNormalSubset1000LL3 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset1000LL3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time

#### XNormalSubset1000ML1 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset1000ML1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time

#### XNormalSubset1000ML3 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset1000ML3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset1000MM1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time

#### XNormalSubset1000MM3 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset1000MM3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time

#### XNormalSubset1000MH1 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset1000MH1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time

#### XNormalSubset1000MH3 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset1000MH3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time

#### XNormalSubset1000HM1 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset1000HM1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time

#### XNormalSubset1000HM3 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset1000HM3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time

#### XNormalSubset1000HH1 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(1))
XNormalSubset1000HH1<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time

#### XNormalSubset1000HH3 ####
cs <- makeCluster(6)
registerDoParallel(cs)
...
PMSPMS<-function(r){(r*RSRS+RSPRSP)^2/((r*RSRS+RSPRSP)^2+(r-1)^2*(RSRS-RSPRSP)^2+(1-RSRS+r*(1-RSPRSP))^2)}
finalperfdf<-finalperf(resdf,RSRS,PMSPMS(3))
XNormalSubset1000HH3<-finalperfdf[[1]]
end.time<-Sys.time()
end.time-start.time